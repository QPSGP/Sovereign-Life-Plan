  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-neutral-100 p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <form action="/api/life-plan/area-of-responsibility" method="POST" className="flex gap-2 mb-4">
          <input type="hidden" name="areaOfPurposeId" value={areaOfPurposeId} />
          <input type="text" name="name" placeholder="Area of responsibility" required className="rounded bg-neutral-800 px-3 py-2 text-white border border-neutral-700 flex-1" />
