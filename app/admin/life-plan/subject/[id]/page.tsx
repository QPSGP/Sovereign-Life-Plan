  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-neutral-100 p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <h2 id="edit" className="text-lg font-medium text-neutral-300 mb-3">Edit this subject/business</h2>
        <form action={"/api/life-plan/subject-business/" + subjectBusinessId} method="POST" className="rounded bg-neutral-900 p-4 mb-6 space-y-2">
            ...
            <tbody>
              {subject.areasOfPurpose.map((a) => (
                <tr key={a.id} className="border-b border-neutral-800">
                  ...
                  <td className="py-2">
                    <Link href={"/admin/life-plan/purpose/" + a.id} className="text-emerald-400 text-sm hover:underline">Open</Link>
                    <span className="mx-1 text-neutral-600">|</span>
                    <Link href={"/admin/life-plan/purpose/" + a.id + "#edit"} className="text-neutral-400 text-sm hover:underline">Edit</Link>
                  </td>
                </tr>
              ))}
            </tbody>
